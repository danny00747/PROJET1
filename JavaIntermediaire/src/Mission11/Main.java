...
public class Main {
	...
	private static Coureur[] coureurs = { 
			new Coureur("Alfred", 24), 
			new Coureur("Bernard", 27),
			new Coureur("Claude", 19), 
			new Coureur("Daniel", 31), 
			new Coureur("Emile", 25), 
			new Coureur("Fred", 28),
			new Coureur("Gerard", 25) };
	...
	public static void main(String[] args) {
		...
		while (true) {
			...
			try {
				Thread.sleep(20000); // attendre deux secondes
