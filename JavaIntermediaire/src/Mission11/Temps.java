...
public class Temps implements Comparable<Object> {
	...
	/**
	 * Normalise les données de ce temps pour obtenir un temps valide. Convertit 60
	 * secondes en 1 minute et 60 minutes en 1 heure si nécessaire pour ramener les
