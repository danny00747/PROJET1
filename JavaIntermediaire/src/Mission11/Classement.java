...
interface Classement {
	 ...
	 *       d'ex-aequo, {r} est inséré après les autres résultats de même ordre.
	 */
	 ...
	 * 
	 * @pre c != null
	 * @post retire le premier (meilleur) résultat pour le coureur {c} du
	 *       classement. {c} est comparé au sens de {equals}. Retourne {true} si un
	 *       résultat a été retiré, {false} si {c} n'est pas trouvé dans la liste.
	 */
	 ...
	 * 
	 * @pre c != null
	 * @post retourne la position du coureur {c} dans le classement, à partir de 1
	 *       pour la tête de classement. Si le coureur figure plusieurs fois dans le
	 *       classement, la première (meilleure) position est retournée. Retourne -1
	 *       si le coureur ne figure pas dans le classement.
	 */
