...
public class LSINF1103 {
	...
	// le main m'a servi a test les méthodes
	public static void main(String[] args) {

		int[] A = { 9, 8, 7, 6, 5, 4, 3, 2, 1, 0 };
		System.out.println("avant sorting");
		for (int i = 0; i < A.length; i++)
			System.out.println(A[i]);
		bubbleSort(A);
		System.out.println("apres sorting");
		for (int i = 0; i < A.length; i++)
			System.out.println(A[i]);
	}
	...
	public static void mergeSort(int[] A, int low, int high) {
		...
		// Pour trier de large collections problème de mémoire (lié à un problème de pile),
